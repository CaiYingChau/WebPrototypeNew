<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebPrototypeNew.Login" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="background-image:url(Images/background.jpg); height:500px">
            <table class="logintable" >
                <tr>
                    <td colspan="2">
                        <h2><asp:Label ID="Label1" runat="server" Text="Customer Login Form"></asp:Label></h2>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td style="text-align:left;">
                        ...
                        <asp:LinkButton ID="createaccount" runat="server" CssClass="fgtPwd"><a href="Register.aspx">Click Here</a></asp:LinkButton>
                        </td>
                </tr>
                <tr>
                    <td>
                        <br />
                        <asp:LinkButton ID="artistLogin" runat="server" CssClass="artlogin"><a href="ArtistLogin.aspx">Artist Login</asp:LinkButton>
                    </td>
                    <td>
